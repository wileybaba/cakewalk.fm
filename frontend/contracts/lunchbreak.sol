...
contract LunchBreak is StandardToken {
    function() {
    ...
    */
    ...
    string public version = "1.1.9"; //human 0.1 standard. Just an arbitrary versioning scheme.

    // must match contract name above
    function LunchBreak() {
        ...
        name = "Lunch"; // Set the name for display purposes
